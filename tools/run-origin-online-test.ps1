...
# Test cible: passer la barriere "Origin offline" avant Auth/10.
# Ce script force les valeurs, meme si l'ancien terminal PowerShell avait garde
# des variables a 0.
...
Write-Host "Test Origin online: ORIGIN_ONLINE_FIX=1, AUTHCODE_FIX=0, VERSION_FIX=0"
