...
/** Permanent memcpy watch = freeze. Brief post-XML window only. */
const COPY_WATCH = false;
const STRLEN_CHASE = false;
/** v111: attach memcpy 300ms after XML found, then detach — catch consumer BT. */
const BRIEF_COPY_MS = 300;
...
console.log(
  "[ssl-bypass] ready — v111-CONSUME: peek + brief XML_COPY → consumer hooks",
);
