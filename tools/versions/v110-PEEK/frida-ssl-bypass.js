...
/**
 * v110: do NOT block closesocket/shutdown — HOLD race emptied LIVE buffer (peek miss).
 * Peek wider around LIVE + follow a few object pointers instead.
 */
...
console.log(
  "[ssl-bypass] ready — v110-PEEK: wide LIVE peek + ptr slots, no HOLD block",
);
