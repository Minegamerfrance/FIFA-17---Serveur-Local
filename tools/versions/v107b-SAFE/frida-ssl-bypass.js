...
/**
 * v107: after XML peek OK, async LEA scan of r-x (NOT during handshake — starves ProtoHttp).
 */
const RX_LEA_ASYNC = true;
/** v107: Heat2 memcmp — OFF by default (hooks every memcmp = kills peek timing). */
