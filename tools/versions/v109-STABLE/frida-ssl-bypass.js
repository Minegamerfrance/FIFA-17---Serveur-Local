...
/** OFF — memcpy/strlen Interceptors during reply = freeze. */
const COPY_WATCH = false;
const STRLEN_CHASE = false;
/** OFF — full-module string scan at boot is heavy. */
...
console.log(
  "[ssl-bypass] ready — v109-STABLE: SSL + connect hijack only (no heavy scans/hooks)",
);
