...
/**
 * v112: ONE-SHOT ±2MB LEA around decision strings after CH.
...
/**
 * v112: targeted LEA (±2MB) to Blaze/ProtoHttp/XmlDecoder strings → hook + force OK.
...
console.log(
  "[ssl-bypass] ready — v112-DECISION: XmlDecoder/ProtoHttp FORCE_OK + connect endian",
);
