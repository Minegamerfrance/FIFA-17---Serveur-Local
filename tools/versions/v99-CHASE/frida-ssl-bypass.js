...
function armResponseMarkerPoll(n, st) {
  ...
  setTimeout(function () {
    ...
    if (!sawRedirectorHttp) {
      ...
      scheduleProofVerdict();
      proof("SUMMARY after hold — peekDone=" + plainDumpDone + " copyHits=" + copyHits);
    }
  }, HOLD_CLOSE_MS + 20);
}
...
hookDecodeDebug();
console.log(
  "[ssl-bypass] ready — Cherche REPLY_COPY / INJECT_REWRITE / ★★★ BLAZE / VERDICT",
);
